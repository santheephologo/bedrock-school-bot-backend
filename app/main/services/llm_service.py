...
class LLMService:
    ...
    def process_request(self, message, clientId, sessionId):
        try:
    ...
    def connectModel(self, message, clientId, sessionId):
        try:    
            ...
            result = self.process_request(message, clientId, sessionId)
            return result
